<template>
  <div class="instructions mt-2 px-4">
    <img src="/logo.png" class="rounded-2xl mx-auto" style="width: 180px; height: 180px; object-fit: contain;"/>
    <h2 class=" text-center text-xl font-semibold mt-3">Welcome to Poly N-Back!</h2>
